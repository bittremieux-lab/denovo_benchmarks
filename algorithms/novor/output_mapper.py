...
class OutputMapper:
    REPLACEMENTS = [
        ...
        ("K(Methyl)", "K[UNIMOD:34]"),
        ("R(Methyl)", "R[UNIMOD:34]"),
        ...
        # Add for 21 PTMs
        ("K(Dimethyl)", "K[UNIMOD:36]"),
        ("R(Dimethyl)", "R[UNIMOD:36]"),
        ("K(Trimethyl)", "K[UNIMOD:37]"),
        ("R(Trimethyl)", "R[UNIMOD:37]"),
        ("K(Crotonyl)", "K[UNIMOD:1363]"),
        ("K(Hydroxyisobut)", "K[UNIMOD:1849]"),
        ("K(Biotin)", "K[UNIMOD:3]"),
        ("K(Propionyl)", "K[UNIMOD:58]"),
        ("K(GlyGly)", "K[UNIMOD:121]"),
        ("K(Butyryl)", "K[UNIMOD:1289]"),
        ("K(Succinyl)", "K[UNIMOD:64]"),
        ("K(Malonyl)", "K[UNIMOD:747]"),
        ("K(Glutaryl)", "K[UNIMOD:1848]"),
        ("R(Citrul)", "R[UNIMOD:7]"),
        ("Y(Nitro)", "Y[UNIMOD:354]"),
        ("W(Nitro)", "W[UNIMOD:354]"),
        ("H(Acetald26)", "H[UNIMOD:254]"),
        ("K(Acetald26)", "K[UNIMOD:254]"),
        ("H(Acetald28)", "H[UNIMOD:255]"),
        ("K(Acetald28)", "K[UNIMOD:255]"),
        ("D(Iron3)", "D[UNIMOD:1870]"),
        ("E(Iron3)", "E[UNIMOD:1870]"),
    ]
